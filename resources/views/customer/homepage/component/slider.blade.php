    ...
    <div class="row sm-gutter" style="background-color: #f5f5f5">
        ...
        <div class="col c-8 l-8 m-8 slideshow-container">
            <div class="mySlider fade">
                <img src="../customer/image/ks1.jpg" style="width:100%" />
                <div class="text">Caption one</div>
            </div>
            {{-- <div class="mySlider fade">
                <img src="../customer/image/ks2.jpg" style="width:100%" />
                <div class="text">Caption Two</div>
            </div>
            <div class="mySlider fade">
                <img src="../customer/image/ks3.jpg" style="width:100%" />
        ...
        <div class="col l-4 c-4 m-4 slider-fixed">
         <div class="slider-position">
             <img src="../customer/image/ks4.jpg" />
         </div>
         <div class="slider-position">
             <img src="../customer/image/ks5.jpg"/>
         </div>
        </div>
    </div>
</div>