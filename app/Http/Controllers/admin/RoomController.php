...
class RoomController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.dashboard.layout', compact( 'rooms', 'numberOfPage', 'pageIndex','config','template'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.dashboard.layout', compact('config','template'));
    }
    ...
    public function edit(Room $room,Request $request)
    {
        ...
        $room=Room::find($r);
         ...
         return view('admin.dashboard.layout', compact( 'room','pageIndex','config','template'));
    }
