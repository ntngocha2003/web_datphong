...
class UserController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('admin.dashboard.layout', compact( 'users', 'numberOfPage', 'pageIndex','config','template'));
    ...
    public function myaccount(User $user,Request $request)
    {
        ...
        $user=User::find($r);
         ...
         $template='customer.homepage.home.myAccount';
         return view('customer.homepage.layout', compact( 'user','pageIndex','config','template'));
    }
    ...
    public function delete(User $user,Request $request){
        ...
        $user=User::find($r);
         ...
         // show form edit
         $config['seo']=config('apps.user');
         $template='admin.user.delete';
         return view('admin.dashboard.layout', compact( 'user','pageIndex','config','template'));
    }
