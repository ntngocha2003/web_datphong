...
class OrderRoomController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $template='backend.orderRoom.index';
    
        return view('backend.dashboard.layout', compact( 'orders', 'numberOfPage', 'pageIndex','config','template'));
    }
    ...
    public function edit(OrderRoom $orderRoom,Request $request)
    {
        ...
        echo $order;
         ...
         // show form edit
         $config['seo']=config('apps.order');
         $template='backend.orderRoom.edit';
         return view('backend.dashboard.layout', compact( 'order','pageIndex','config','template'));
    }
    ...
    public function delete(OrderRoom $order,Request $request){
        ...
        $order=OrderRoom::find($r);
         ...
         $config['seo']=config('apps.order');
         $template='backend.orderRoom.delete';
         return view('backend.dashboard.layout', compact( 'order','pageIndex','config','template'));
    }
